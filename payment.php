...
if (!$pending_booking || $pending_booking['session_id'] != $session_id) {
    ...
    <div class="payment-container">
        ...
        <div class="booking-details">
            <div class="detail-row">
                <span>Mentor:</span>
                <strong><?php echo htmlspecialchars($pending_booking['mentor_name']); ?></strong>
            </div>
            <div class="detail-row">
                <span>Date & Time:</span>
                <strong><?php echo date('M d, Y - H:i', strtotime($pending_booking['scheduled_at'])); ?></strong>
            </div>
            <div class="detail-row">
                <span>Duration:</span>
            ...
            <div class="detail-row total">
                ...
                <span>$<?php echo number_format($pending_booking['amount'], 2); ?></span>
            </div>
        </div>
